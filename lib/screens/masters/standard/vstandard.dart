...
class VStandard extends StatefulWidget {
  const VStandard({super.key});

  @override
  State<VStandard> createState() => _VStandardState();
}

class _VStandardState extends State<VStandard>
    with SingleTickerProviderStateMixin {
  ApiStandard api = ApiStandard();
  late Future<List<Standard>?> _future;
  ...
  late List<Standard> _standardData;
  @override
  void initState() {
    ...
    animation = Tween<double>(begin: 0, end: 1).animate(CurvedAnimation(
        parent: _animationController, curve: Curves.fastOutSlowIn));
    _future = api.advanceSearchStandard(_searchController.text);
      ...
      child: CustomScrollView(
        slivers: <Widget>[
          const SliverPersistentHeader(
            delegate: SliverSearchAppBar("Standard(s)"),
            pinned: true,
          ),
          loadFutureList()
        ],
                      ...
                      onPressed: () => {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                  ...
                                  setState(() {
                                    _standardData = [];
                                    _future = api.advanceSearchStandard(
                  ...
                  child: TextField(
                    ...
                    onChanged: (value) {
                      setState(() {
                        ...
                        _future =
                            api.advanceSearchStandard(_searchController.text);
                      });
                    },
                      ...
                      suffixIcon: IconButton(
                        ...
                        onPressed: () => {
                          ...
                          setState(() {
                            ...
                            _future = api
                                .advanceSearchStandard(_searchController.text);
                          })
                        },
                      ),
  ...
  Widget loadFutureList() {
    ...
    return FutureBuilder<List<Standard>?>(
      future: _future, // function where you call your api
      builder: (BuildContext context, AsyncSnapshot<List<Standard>?> snapshot) {
        ...
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          if (snapshot.hasError) {
            ...
            _standardData = snapshot != null && snapshot.data != null
                ? snapshot.data! ?? []
                : [];
            return SliverToBoxAdapter(
                child: Container(
  ...
  listObject() {
    return (_standardData.isNotEmpty
        ? _standardData
            .map((standard) => Padding(
                  ...
                  child: SecondaryCourseCard(
                    ...
                    iconsSrc: "$assetsLocation/icons/standards.svg",
                    data: standard,
                  ),
                ))
            .toList()
