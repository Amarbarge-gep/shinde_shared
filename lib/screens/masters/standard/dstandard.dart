...
class StandardForm extends StatefulWidget {
  ...
  const StandardForm({super.key, required this.standard});
...
class _StandardFormState extends State<StandardForm> {
  ApiStandard apiStandard = ApiStandard();
  ...
  @override
  void initState() {
    _controllerName.text = widget.standard.name;
    _controllerDesc.text = widget.standard.description;
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(
                    ILocalization(_prefs).get("standards"),
                            ...
                            onPressed: () {
                              ...
                              Future.delayed(const Duration(seconds: 2), () {
                                ...
                                if (widget.standard.id == "") {
                                  ...
                                  standard.id = widget.standard.id;
                                  apiStandard
